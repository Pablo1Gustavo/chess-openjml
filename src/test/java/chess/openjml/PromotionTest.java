...
public class PromotionTest
{
    ...
    private static void testPromotionToQueen()
    {
        ...
        board.grid[6][4] = Optional.of(new Pawn(new Position(6, 4), Color.WHITE));
        ...
        boolean isQueen = board.getPieceAt(new Position(7, 4)).isPresent() && 
                         board.getPieceAt(new Position(7, 4)).get() instanceof Queen;
        boolean correctColor = board.getPieceAt(new Position(7, 4)).isPresent() &&
                              board.getPieceAt(new Position(7, 4)).get().getColor() == Color.WHITE;
    ...
    private static void testPromotionToRook()
    {
        ...
        board.grid[6][0] = Optional.of(new Pawn(new Position(6, 0), Color.WHITE));
        ...
        boolean isRook = board.getPieceAt(new Position(7, 0)).isPresent() && 
                        board.getPieceAt(new Position(7, 0)).get() instanceof Rook;
    ...
    private static void testPromotionToKnight()
    {
        ...
        board.grid[6][7] = Optional.of(new Pawn(new Position(6, 7), Color.WHITE));
        board.grid[0][4] = Optional.of(new King(new Position(0, 4), Color.WHITE));
        board.grid[7][4] = Optional.of(new King(new Position(7, 4), Color.BLACK));
        
        boolean success = SANParser.parseSANAndMove(game, "h8=N");
        
        boolean isKnight = board.getPieceAt(new Position(7, 7)).isPresent() && 
                          board.getPieceAt(new Position(7, 7)).get() instanceof Knight;
    ...
    private static void testPromotionWithCapture()
    {
        ...
        board.grid[6][3] = Optional.of(new Pawn(new Position(6, 3), Color.WHITE));
        board.grid[7][4] = Optional.of(new Rook(new Position(7, 4), Color.BLACK));
        board.grid[0][4] = Optional.of(new King(new Position(0, 4), Color.WHITE));
        board.grid[7][0] = Optional.of(new King(new Position(7, 0), Color.BLACK));
        ...
        boolean isQueen = board.getPieceAt(new Position(7, 4)).isPresent() && 
                         board.getPieceAt(new Position(7, 4)).get() instanceof Queen;
        boolean oldSquareEmpty = board.isCellEmpty(new Position(6, 3));
    ...
    private static void testBlackPromotion()
    {
        ...
        board.grid[1][4] = Optional.of(new Pawn(new Position(1, 4), Color.BLACK));
        board.grid[0][0] = Optional.of(new King(new Position(0, 0), Color.WHITE));
        board.grid[7][7] = Optional.of(new King(new Position(7, 7), Color.BLACK));
        ...
        boolean isQueen = board.getPieceAt(new Position(0, 4)).isPresent() && 
                         board.getPieceAt(new Position(0, 4)).get() instanceof Queen;
        boolean correctColor = board.getPieceAt(new Position(0, 4)).isPresent() &&
                              board.getPieceAt(new Position(0, 4)).get().getColor() == Color.BLACK;
